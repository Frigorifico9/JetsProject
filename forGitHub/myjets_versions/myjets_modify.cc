...
int main() 
{
  ...
  TH2D*  hist_pTdelta_AjInc = new TH2D("hist_pTdelta", "The momentum of particles in each Delta Ring", 9, 0, 1.8, 1000, -20, 20); //Aj inclusive
  TH2D*  hist_pTdelta_AjA   = new TH2D("hist_pTdelta", "The momentum of particles in each Delta Ring", 9, 0, 1.8, 1000, -20, 20); //Aj above Aj_V 
  TH2D*  hist_pTdelta_AjB   = new TH2D("hist_pTdelta", "The momentum of particles in each Delta Ring", 9, 0, 1.8, 1000, -20, 20); //Aj bellow Aj_V
...
//####################################################################################################
  ...
  histos->cd();
  hist_pTdelta->Write();
  hist_pTdelta_AjA->Write();
  hist_pTdelta_AjB->Write();
  histos->Close();
